...
const drugCategories = [
  ...
  { name: 'Cardio', value: 32 },
  { name: 'Onco', value: 12 },
  { name: 'Diabetic', value: 28 },
    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <StatCard 
          ...
          value="482" 
          trend={5.4} 
          subtitle="Avg per day this week"
          icon={<svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg>}
        />
        <StatCard 
          title="Drug Inventory Value" 
          value="¥2.4M" 
        ...
        <StatCard 
          ...
          value="14 Items" 
          trend={-20} 
          subtitle="Critical shortage warning"
        ...
        <StatCard 
          ...
          value="78%" 
          trend={1.2} 
          subtitle="Treatment follow-up rate"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
          <h2 className="text-lg font-bold text-slate-900 mb-6">Weekly Prescription Volume</h2>
          <div className="h-80">
        ...
        <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
          <h2 className="text-lg font-bold text-slate-900 mb-6">Prescription by Category</h2>
          <div className="h-80">
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={drugCategories}>
                <CartesianGrid strokeDasharray="3 3" vertical={false} stroke="#f1f5f9" />
